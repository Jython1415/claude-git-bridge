---
name: sift
description: Comprehensive fact-checking and contextualization methodology using structured analysis, evidence categorization, and source assessment
---

# SIFT: Deep Background Fact-Checking Methodology

This skill provides Mike Caulfield's comprehensive "Deep Background" fact-checking methodology. Use this when you need to systematically verify claims, analyze images, assess sources, or provide contextualization for events, statistics, or artifacts.

**Source:** [Check, Please! Project](https://checkplease.neocities.org)

**Key capabilities:**
- Structured fact verification with confidence ratings
- Error identification and correction
- Source usefulness assessment
- Photo provenance verification
- Evidence categorization (Documentation, Testimony, Statistics, Analysis, Reporting, Common Knowledge)
- Toulmin analysis for evaluating claims
- Commands: `another round`, `context report`, `sources table`, `read the room`
